...
<script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            Swal.fire({
              //  icon: 'info',
                title: 'Hola!!',
                text: 'Estas en la pagina web !!',
                confirmButtonText: 'Comenzar',
                imageUrl: 'https://png.pngtree.com/png-vector/20190110/ourlarge/pngtree-vector-web-page-icon-png-image_312554.jpg', // URL de tu imagen
